...
-----
    ...
    python -m scripts.run_full_analysis

Or edit COMPANY_NAME / TICKER / EXCHANGE below to point at a different
...
logger = logging.getLogger("scripts.run_full_analysis")
